...
class DTNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, width, in_channels=3, recall=True, group_norm=False, recall_relu=False, **kwargs):
        super().__init__()
...
def dt_net_2d(width, **kwargs):
    return DTNet(BasicBlock, [2], width=width, in_channels=kwargs["in_channels"], recall=False, recall_relu=kwargs["recall_relu"])


def dt_net_recall_2d(width, **kwargs):
    return DTNet(BasicBlock, [2], width=width, in_channels=kwargs["in_channels"], recall=True, recall_relu=kwargs["recall_relu"])


def dt_net_gn_2d(width, **kwargs):
    return DTNet(BasicBlock, [2], width=width, in_channels=kwargs["in_channels"], recall=False, group_norm=True, recall_relu=kwargs["recall_relu"])


def dt_net_recall_gn_2d(width, **kwargs):
    return DTNet(BasicBlock, [2], width=width, in_channels=kwargs["in_channels"], recall=True, group_norm=True, recall_relu=kwargs["recall_relu"])
