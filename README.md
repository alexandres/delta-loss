...
This is the code repository for the paper [A Simple Loss Function for Convergent Algorithm Synthesis using RNNs](https://openreview.net/pdf?id=WaAJ883AqiY) by Alexandre Salle and Shervin Malmasi.

It is based on [this repository](https://github.com/aks2203/deep-thinking). The main modifications are in the file `deepthinking/utils/training.py`, function `train_delta`.

## Installation

If you have [Conda](https://docs.conda.io/en/latest/miniconda.html) installed, run:
